...
function meteor_author_box() {
	...
	<div class="author-profile">
		...
		<a class="author-profile-avatar" href="<?php printf( '<a href="%1$s"><i class="fa fa-external-link"></i> %2$s</a>', esc_url( $author->user_url ), 'Website', 'meteor' ); ?>" title="<?php echo esc_attr( sprintf( esc_html__( 'Posts by %s', 'meteor' ), get_the_author() ) ); ?>"><?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'meteor_author_bio_avatar_size', 65 ) ); ?></a>
